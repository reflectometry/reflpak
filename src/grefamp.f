C Subroutine calculates reflected amplitude of NLAYER stack
C exactly (without the roughness correction of REFINT)
C From Parratt, Phys. Rev. 95, 359(1954)
C John Ankner 14 December 1992
        subroutine GREFAMP(QI,LAMBDA,GQCSQ,GMU,GD,NGLAY,
     *     GAMPREAL,GAMPIMAG)
        ...
        double precision GAMPREAL,GAMPIMAG
